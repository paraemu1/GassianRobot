#!/usr/bin/env python3
"""Prepare and/or train from an existing Gaussian input run."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prep and/or train from an existing run")
    parser.add_argument(
        "--run",
        default="",

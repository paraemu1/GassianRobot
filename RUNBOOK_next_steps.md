...
Quick commands: `FIRST_SUCCESS_COMMANDS.md`
Create 3 triage + field notes: `CREATE3_NETWORK_TRIAGE.md`
RTAB-Map setup: `TUTORIAL_rtabmap_setup_and_capture.md`
Nav2 + RTAB-Map pathfinding: `TUTORIAL_nav2_with_rtabmap.md`
Session handoff record: `SESSION_HANDOFF_2026-02-17.md`

## Current status snapshot (2026-02-17)
- Create 3 networking is working (see `CREATE3_NETWORK_TRIAGE.md`).
